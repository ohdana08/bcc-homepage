// BCC 기관 제안 작업메일 자동화
// 전용 Gmail 수신 → BCC 서버 처리 → 서버가 지정한 Daum 주소 한 곳으로만 결과 전달
// 원발신자에게 답장하거나 CC/BCC를 추가하지 않는다.

var BCC_PROPOSAL_ENDPOINT = 'https://bcc-homepage.vercel.app/api/cardnews-generate';
var BCC_PROCESSED_LABEL = 'BCC_PROCESSED';
var BCC_PROCESSING_LABEL = 'BCC_PROCESSING';
var BCC_ERROR_LABEL = 'BCC_ERROR';
