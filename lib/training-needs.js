...
export const TRAINING_NEED_QUESTIONS = [
  ...
  {
    id: 'free_ai_tools',
    title: '지금 무료로 쓰는 AI 도구가 있나요?',
    help: '무료 회원이나 체험판으로 쓰는 도구를 모두 골라주세요.',
    type: 'multi',
    max: 18,
    required: true,
    options: [
      ['none', '무료로 쓰는 AI 도구는 없다'],
      ['chatgpt', 'ChatGPT'],
      ['gemini', 'Gemini'],
      ['claude', 'Claude'],
      ...
      ['runway', 'Runway'],
      ['kling_veo', 'Kling·Veo'],
      ['capcut_vrew', 'CapCut·Vrew'],
      ['other', '기타'],
    ],
  },
  {
    id: 'paid_ai_tools',
    title: '지금 돈을 내고 쓰는 AI 도구가 있나요?',
    help: '본인이나 회사가 유료로 결제 중인 도구만 모두 골라주세요.',
    type: 'multi',
    max: 18,
    required: true,
    options: [
      ['none', '유료로 결제한 AI 도구는 없다'],
      ['chatgpt', 'ChatGPT'],
      ['gemini', 'Gemini'],
      ['claude', 'Claude'],
      ['copilot', 'Microsoft Copilot'],
