...
export const TRAINING_NEED_QUESTIONS = [
  {
    id: 'current_context',
    title: '현재 가장 가까운 역할은 무엇인가요?',
    help: '수업 사례와 실습 소재를 정하는 데 사용합니다.',
    type: 'single',
    required: true,
    options: [
      ['office_admin', '사무·행정'],
      ['education_research', '교육·연구'],
      ['marketing_content', '홍보·마케팅·콘텐츠'],
      ['counseling_welfare', '상담·복지·고객응대'],
      ['job_seeking', '취업·이직 준비'],
      ['startup_business', '창업·사업 운영'],
      ['student', '학생·학습자'],
      ['other', '기타'],
    ],
  },
  {
    id: 'ai_experience',
    title: 'AI를 어느 정도로 사용해 봤나요?',
    help: '초급·중급이라는 느낌보다 실제 행동에 가까운 항목을 골라주세요.',
    type: 'single',
    required: true,
    options: [
      ...
      ['custom_automation', '나만의 GPT·Gems·자동화를 만들어 봤다'],
      ['other', '기타'],
    ],
  },
  {
    id: 'ai_tools',
    title: '사용해 본 AI 도구를 모두 골라주세요.',
    help: '없다면 ‘사용해 본 도구 없음’을 누르면 됩니다.',
    type: 'multi',
    max: 6,
    required: true,
    options: [
      ...
      ['image_video', '이미지·영상 AI'],
      ['other', '기타'],
    ],
  },
  {
    id: 'work_tasks',
    title: 'AI로 가장 먼저 도움받고 싶은 일은 무엇인가요?',
    help: '가장 중요한 것 3개까지 선택해 주세요.',
    type: 'multi',
    max: 3,
    required: true,
    options: [
  ...
  {
    id: 'pain_points',
    title: 'AI를 쓸 때 가장 막히는 지점은 무엇인가요?',
    help: '3개까지 선택할 수 있습니다.',
    type: 'multi',
    max: 3,
    required: true,
    options: [
      ...
      ['security', '업무자료를 넣어도 되는지 불안하다'],
      ['free_limit', '무료버전·사용량 제한에 막힌다'],
  ...
  {
    id: 'desired_topics',
    title: '이번 강의에서 가장 배우고 싶은 내용은 무엇인가요?',
    help: '우선순위가 높은 것 3개까지 골라주세요.',
    type: 'multi',
    max: 3,
    required: true,
    options: [
  ...
  {
    id: 'desired_outputs',
    title: '강의가 끝날 때 어떤 결과물을 가져가고 싶은가요?',
    help: '직접 만들어 보고 싶은 것 2개까지 선택해 주세요.',
    type: 'multi',
    max: 2,
    required: true,
    options: [
      ...
      ['data_summary', '데이터 정리표·차트'],
      ['custom_chatbot', '나만의 GPT·Gems·챗봇'],
  ...
  },
  {
    ...
    title: '강의 당일 실습 환경은 어떤가요?',
    help: '해당하는 항목을 모두 골라주세요.',
    type: 'multi',
    max: 5,
    required: true,
    options: [
      ['own_laptop', '개인 노트북을 사용할 수 있다'],
      ['institution_pc', '기관 PC를 사용한다'],
      ['mobile_only', '스마트폰·태블릿만 사용 가능하다'],
      ['free_account', '무료 AI 계정만 사용한다'],
      ['paid_account', '유료 AI 계정이 있다'],
      ['unknown', '아직 모르겠다'],
      ['other', '기타'],
    ],
  },
  {
    id: 'data_security',
    title: '실습에 사용할 자료에 대해 알려주세요.',
    help: '강사가 안전한 예시와 실습 방식을 준비하는 데 사용합니다.',
    type: 'single',
    required: true,
    options: [
      ['anonymized_work', '개인정보를 지운 실제 업무자료를 사용하고 싶다'],
      ['sample_only', '강사가 준비한 예시자료로만 실습하고 싶다'],
      ['no_work_data', '업무자료를 AI에 넣을 수 없다'],
      ['not_sure', '어떤 자료까지 가능한지 모르겠다'],
      ['other', '기타'],
    ],
  },
  {
    id: 'open_question',
    title: '이번 강의에서 꼭 다뤄주길 바라는 상황이나 질문이 있나요?',
    help: '선택사항입니다. 실명·전화번호·기밀정보는 적지 말아주세요.',
    type: 'text',
    required: false,
  },
];
...
export function normalizeAnswers(input = {}) {
  ...
  for (const question of TRAINING_NEED_QUESTIONS) {
    ...
    if (values.includes('none') && values.length > 1) {
      throw Object.assign(new Error('‘사용해 본 도구 없음’은 다른 도구와 함께 선택할 수 없습니다.'), { httpStatus: 400 });
    }
...
export function summarizeResponses(rows = []) {
  ...
  for (const question of TRAINING_NEED_QUESTIONS) {
    ...
    for (const row of safeRows) {
      ...
      if (question.type === 'multi') values.push(...(Array.isArray(answer) ? answer : []));
